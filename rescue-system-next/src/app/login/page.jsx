...
import { authService } from '../../../services/api';  // ✅ FIXED PATH
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (userData && token) {
                ...
                if (userRole === "admin") router.push("/admin/overview");
                else if (userRole === "dispatcher" || userRole === "responder") router.push("/dashboard");
                else if (userRole === "volunteer") router.push("/volunteer-dashboard");
                else if (userRole === "civilian") router.push("/civilian-dashboard");
                ...
                >
                    ...
                    <div className="grid md:grid-cols-2 gap-10 items-center">
                        <div>
                            ...
                            <button onClick={() => router.push('/Guest/Report')} className="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 py-3 rounded-md font-medium transition flex items-center justify-center gap-2 mt-3">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" /></svg>
                                Report as Guest
                            </button>

                            <p className="text-center text-sm text-gray-600 mt-5">
                                Don't have an account? <Link href="/signup" className="text-red-400 font-medium hover:underline cursor-pointer">Sign up</Link>
                            </p>

                            <div className="mt-4 text-center text-sm text-gray-500">
                                <Link href="/" className="text-[#FF6B6B] hover:text-[#E55A5A] transition-colors">
                                    ← Back to Home
                                </Link>
                            </div>
                        </div>
