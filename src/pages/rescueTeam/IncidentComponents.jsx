...
/**
 * Checkbox All Component
 * Displays a checkbox with minus icon for bulk selection
 */
...
/**
 * Stat Card Component
 * Displays a statistics card with title, value, icon, and optional trend
 */
export function StatCard({ title, value, icon, color, trend }) {
    // Derive background color from text color
