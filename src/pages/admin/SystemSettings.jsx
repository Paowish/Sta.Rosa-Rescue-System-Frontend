 ...
 * Manages system configuration including general, security, and notification settings
 */
export default function SystemSettings() {
    ...
    /**
     * Confirm and execute reset for a specific section
     */
    const confirmReset = () => {
        try {
    ...
    /**
     * Confirm and execute dangerous actions
     */
    ...
    /**
     * Close danger confirmation modal
     */
                ...
                <div className="bg-white rounded-lg shadow-2xl w-[480px] max-w-[95vw] overflow-hidden">
                    ...
                    <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-[20px] font-bold text-gray-800">{titles[resetTarget]}</h3>
                        </div>
    ...
    const DangerConfirmationModal = () => {
        ...
        const modalData = {
            ...
            clear_accounts: {
                ...
                subtitle: 'This will permanently delete all non-admin user accounts. Admin accounts are preserved.',
                tableRows: [
                    { label: 'Accounts to delete', value: 'All non-admin users' },
                    { label: 'Roles Affected', value: 'Responder, Volunteer, Civilian' },
                    { label: 'Admin accounts kept', value: 'Preserved' }
                ]
            }
        };
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden mb-6">
                <div className="p-4 border-b bg-[#EAE9F9] flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {!isGeneralEditable ? (
                            <button onClick={() => setIsGeneralEditable(true)} className="bg-[#0C7FDA] hover:bg-[#0b6eb5] text-white text-xs px-3 py-1 rounded font-medium flex items-center gap-1 transition-colors">
                                <Icon icon="mdi:pencil" className="w-3 h-3" /> Edit
                            </button>
                        ) : (
                            <button onClick={() => { setGeneral(generalBackup); setIsGeneralEditable(false); }} className="bg-gray-500 hover:bg-gray-600 text-white text-xs px-3 py-1 rounded font-medium flex items-center gap-1 transition-colors">
                                <Icon icon="mdi:close" className="w-3 h-3" /> Cancel
                            </button>
                        )}
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full border border-gray-300 rounded px-3 py-1.5 text-sm text-gray-700 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 bg-white ${!isGeneralEditable ? 'bg-gray-100 cursor-not-allowed opacity-70' : ''}`}
                            />
                        </div>
                        <div>
                            ...
                            <select
                                ...
                                disabled={!isGeneralEditable}
                                className={`w-full border border-gray-300 rounded px-3 py-1.5 text-sm text-gray-700 bg-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 ${!isGeneralEditable ? 'bg-gray-100 cursor-not-allowed opacity-70' : ''}`}
                            >
                    ...
                    <div className="p-4 flex justify-between items-start">
                        ...
                        <div className="shrink-0">
                            <input
                                ...
                                disabled={true}
                                className="w-20 border border-gray-300 rounded px-3 py-1.5 text-sm text-gray-700 bg-gray-100 cursor-not-allowed opacity-70 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-right"
                                min="1"
                                max="1440"
                            />
                        </div>
                    ...
                    <div className="p-4 flex justify-between items-center">
                        ...
                        <div className="shrink-0">
                            <ToggleSwitch
                                ...
                                onChange={() => setNotifications({ ...notifications, systemErrors: !notifications.systemErrors })}
                            />
                        </div>
                    </div>
            ...
            <div className="bg-white rounded-lg shadow border border-red-200 overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <button onClick={() => { setResetTarget('general'); setDangerAction(null); }} className="px-4 py-1.5 bg-[#dc2626] text-white text-[11px] font-medium rounded hover:bg-[#b91c1c] transition whitespace-nowrap shadow-sm">
                            RESET SETTINGS
                        </button>
                    </div>
                    <div className="flex justify-between items-center">
