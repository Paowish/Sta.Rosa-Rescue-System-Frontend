 ...
 * Displays dispatch confirmation with incident details and action buttons
 */
const DispatchCard = React.memo(({
    ...
    const questionText = isAccept
        ? 'Are you sure you want to accept this dispatch request?'
        : 'Are you sure you want to decline this dispatch request?';
    ...
    const handleConfirm = () => {
        ...
        if (isAccept) {
            ...
            // Broadcast to track page via BroadcastChannel
            try {
            ...
            // Backup: Force trigger via LocalStorage
            try {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-[600px] max-w-[95vw] p-6 flex flex-col relative z-[160] max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center gap-3 pb-4 border-b border-gray-200 mb-4">
                    <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="currentColor"
                        className={`w-7 h-7 transition-all duration-300 ${isAccept ? 'text-[#2e7d32]' : 'text-red-600'}`}
                    >
                        {isAccept ? (
                    ...
                    <button
                        ...
                        className="ml-auto text-gray-400 hover:text-gray-600 transition-colors duration-200 text-2xl leading-none hover:scale-110 transform"
                    >
                        ×
                    </button>
                </div>
                ...
                <div className="flex flex-col items-end gap-4 mt-auto">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={handleCancelDispatch}
                            className="px-6 py-2 bg-white border border-gray-300 rounded text-gray-600 font-medium text-sm hover:bg-gray-50 transition-all duration-200 shadow-sm"
                        >
                            Cancel
                        </button>
                        <button
