...
/**
 * Arrival Modal Component
 * Confirms volunteer arrival at incident scene and prompts for resolution
 */
const ArrivalModal = ({ isOpen, onClose, onSolve, incident }) => {
    // Don't render if modal is closed or no incident
        ...
        <div className="fixed inset-0 flex items-center justify-center z-[300] p-4">
            ...
            <div className="bg-white rounded-xl shadow-2xl w-[450px] max-w-[95vw] p-6 flex flex-col relative z-[310] max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        onClick={onSolve}
                        className="flex-1 py-2.5 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 transition-all duration-200"
                    >
                        ✅ Solve Incident
                    </button>
                </div>
                ...
                <p className="text-xs text-gray-400 text-center mt-3">
                    Click "I'm Not Ready" to keep the Accept/Decline buttons visible.
                </p>
            </div>
        </div>
    );
