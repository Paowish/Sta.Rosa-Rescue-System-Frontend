...
const DirectionsPanel = ({ isEnRoute, selectedIncident, distanceToIncident, timeToIncident, stopLocationTracking }) => {
    ...
    return (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-[1000] bg-white/95 backdrop-blur-sm rounded-xl shadow-lg px-4 py-3 border border-gray-200 min-w-[280px]">
            <div className="flex items-center justify-between">
                ...
                <button onClick={stopLocationTracking} className="text-xs font-medium text-red-500 hover:text-red-700 transition-colors">Stop</button>
            </div>
        </div>
    );
};
