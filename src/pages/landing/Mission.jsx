    ...
    return (
        <div className="min-h-screen bg-[#F5F7FA] py-20 px-6">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                {/* Right Grid - Icons (Replace these with your Figma icons) */}
                <div className="grid grid-cols-3 gap-4">
                    {[
                        ...
                        <div key={idx} className={`flex flex-col items-center justify-center p-4 rounded-lg border ${item.color} aspect-square transition hover:shadow-md`}>
