// src/pages/guest/GuestReport.jsx
...
export default function GuestReport() {
    ...
    return (
        <div className="min-h-screen bg-[#f4f5f7]">
            {/* Outer Container */}
            <div className="w-full px-3 sm:px-4 pt-3 sm:pt-4 pb-4 max-w-6xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className={`flex items-center gap-2 ${currentStep >= 2 ? 'text-[#1f6b75]' : 'text-gray-400'}`}>
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${currentStep >= 2 ? 'bg-[#1f6b75] text-white' : 'bg-gray-200 text-gray-500'}`}>2</div>
                ...
                <div className="mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-[#474C53] font-semibold text-[32px]">File Report</h1>
                    </div>
